...
import './Diferencia_varianza_desconocida_ngrade.css';

const Diferencia_varianza_desconocida_ngrade = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('/api/Form_diferencia_medias_varianza_desconocida', {
                method: 'POST',
    ...
    return (
        <div className="container">
            <h2>Prueba de Hipótesis (Diferencia de Varianzas, Muestra Grande)</h2>
...
export default Diferencia_varianza_desconocida_ngrade;
