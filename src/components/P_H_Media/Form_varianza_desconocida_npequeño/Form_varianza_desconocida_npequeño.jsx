...
import './Form_varianza_desconocida_npequeño.css';

const Form_varianza_desconocida_npequeño = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('/api/Form_varianza_desconocida_npequeño', {
                method: 'POST',
    ...
    return (
        <div className="container">
            <h2>Prueba de Hipótesis (Varianza Desconocida, Muestra Pequeña)</h2>
...
export default Form_varianza_desconocida_npequeño;
